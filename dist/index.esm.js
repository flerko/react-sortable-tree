...
var DndManager = /*#__PURE__*/function () {
  ...
  _createClass(DndManager, [{
    ...
    key: "wrapSource",
    value: function wrapSource(el, beginDragFunc) {
      var _this = this;
...
var ReactSortableTree = /*#__PURE__*/function (_Component) {
  ...
  function ReactSortableTree(props) {
    ...
    var _mergeTheme = mergeTheme(props),
        ...
        beginDragFunc = _mergeTheme.beginDragFunc;
    ...
    _this.nodeContentRenderer = _this.dndManager.wrapSource(nodeContentRenderer, beginDragFunc);
